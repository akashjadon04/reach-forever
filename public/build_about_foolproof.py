...
# Grab everything before the hero section (head, styles, nav)
head_and_header = html[:html.find('<!-- HERO -->')]

# Grab everything from the footer to the end of the file
...
about_content = """
<!-- HERO -->
<section class="hero-section" style="padding: 160px 5% 80px 5%; background: var(--bg); position: relative; overflow: hidden; text-align: center;">
  ...
  <div style="max-width: 1000px; margin: 0 auto; position: relative; z-index: 2;">
    <h1 style="font-family: var(--ss); font-size: clamp(3rem, 6vw, 5rem); font-weight: 800; color: var(--tx); line-height: 1.1; margin-bottom: 20px; letter-spacing: -2px;">
    ...
    <p style="font-family: var(--sm); font-size: 1.2rem; color: var(--tx3); max-width: 800px; margin: 0 auto; line-height: 1.8;">
...
<!-- Vision & Mission -->
<section id="visionMissionSec" style="padding: 100px 5%; background: var(--bg); position: relative;">
  <div style="max-width:1200px; margin:0 auto; display:grid; grid-template-columns:repeat(auto-fit, minmax(300px, 1fr)); gap:40px;">
    
    <!-- Vision -->
    <div style="background:var(--dark); border-radius:24px; padding:50px; border:1px solid rgba(0,0,0,.05); position:relative; overflow:hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.02);">
      ...
      <h2 style="font-family:var(--ss); font-size:2rem; font-weight:700; color:var(--tx2); margin-bottom:20px;">Our Vision</h2>
      <p style="font-family:var(--sb); font-size:1rem; color:var(--tx3); line-height:1.7;">
    ...
    <div style="background:var(--dark); border-radius:24px; padding:50px; border:1px solid rgba(0,0,0,.05); position:relative; overflow:hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.02);">
      ...
      <h2 style="font-family:var(--ss); font-size:2rem; font-weight:700; color:var(--tx2); margin-bottom:20px;">Our Mission</h2>
      <p style="font-family:var(--sb); font-size:1rem; color:var(--tx3); line-height:1.7;">
...
<section id="valuesSec" style="padding: 100px 5%; background: var(--dark); position: relative; overflow: hidden;">
  ...
  <div style="max-width:1200px; margin:0 auto; position:relative; z-index:2; text-align:center; margin-bottom:60px;">
    <h2 style="font-family:var(--ss); font-size:clamp(2.5rem,4vw,3.5rem); font-weight:800; color:var(--tx); margin-bottom:15px; letter-spacing:-1px;">The Reach <em style="color:#b3277b; font-style:normal;">Standard</em></h2>
    <p style="font-family:var(--sm); font-size:1.1rem; color:var(--tx3); max-width:600px; margin:0 auto;">We operate differently from traditional agencies. Our entire ecosystem is built around three core pillars.</p>
  </div>
  ...
  <div style="max-width:1200px; margin:0 auto; display:grid; grid-template-columns:repeat(auto-fit, minmax(300px, 1fr)); gap:30px; position:relative; z-index:2;">
    <!-- Value 1 -->
    <div style="background:var(--bg); border-radius:24px; padding:40px; border:1px solid rgba(0,0,0,.05); box-shadow: 0 5px 20px rgba(0,0,0,0.03); transition:transform .3s var(--ex);">
      ...
      <h3 style="font-family:var(--ss); font-size:1.5rem; font-weight:700; color:var(--tx2); margin-bottom:15px;">Proof, Not Promises</h3>
      <p style="font-family:var(--sb); font-size:0.95rem; color:var(--tx3); line-height:1.7;">We believe in transparent metrics and tangible ROI. If we can't measure it and prove its value, we don't do it.</p>
    </div>
    <!-- Value 2 -->
    <div style="background:var(--bg); border-radius:24px; padding:40px; border:1px solid rgba(0,0,0,.05); box-shadow: 0 5px 20px rgba(0,0,0,0.03); transition:transform .3s var(--ex);">
      ...
      <h3 style="font-family:var(--ss); font-size:1.5rem; font-weight:700; color:var(--tx2); margin-bottom:15px;">Exclusivity</h3>
      <p style="font-family:var(--sb); font-size:0.95rem; color:var(--tx3); line-height:1.7;">We only take on a few select clients. When you work with Reach Forever, you get our full, undivided attention and resources.</p>
    </div>
    <!-- Value 3 -->
    <div style="background:var(--bg); border-radius:24px; padding:40px; border:1px solid rgba(0,0,0,.05); box-shadow: 0 5px 20px rgba(0,0,0,0.03); transition:transform .3s var(--ex);">
      ...
      <h3 style="font-family:var(--ss); font-size:1.5rem; font-weight:700; color:var(--tx2); margin-bottom:15px;">Rapid Execution</h3>
      <p style="font-family:var(--sb); font-size:0.95rem; color:var(--tx3); line-height:1.7;">In the digital space, speed wins. We deploy campaigns, funnels, and content systems faster than anyone in the industry.</p>
    </div>
  </div>
</section>
"""
...
print("Successfully generated foolproof about.html!")
