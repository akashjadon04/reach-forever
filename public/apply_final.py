...
with open('index_fe77818.html', 'r', encoding='utf-8') as f:
    html = f.read()

# 1. Update phone badge
...
# 3. Remove proofSec completely! (the videos slider)
html = re.sub(r'<!-- PROOF NOT PROMISES -->\s*<section id="proofSec".*?</section>', '', html, flags=re.DOTALL)
